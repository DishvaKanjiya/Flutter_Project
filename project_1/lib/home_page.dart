                ...
                Row(
                  children: [
                    Expanded(child: Padding(
                      ...
                      child: Container(
                        child: Text("Traveling made \n easy!",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 50),),
                      ),
                    ),),
                ...
                Row(
                  children: [
                    Expanded(child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Container(
                        child: Text("Experience the world's best adventure around the world with us.",style: TextStyle(color: Colors.white,fontSize:30 ),),
                      ),
                    ),),
                    Expanded(child: Container(),),
                  ],
